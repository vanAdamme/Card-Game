...
if sprite_index == values.face
{
	...
	draw_text(_xx + 90, _yy + 18, values.title);

	draw_set_halign(fa_left);
	draw_set_valign(fa_top);

	draw_text(_xx + 30, _yy + 124, string(values.attack_val_m));
	draw_text(_xx + 40, _yy + 138, string(values.attack_val_sd));

	draw_text(_xx + 30, _yy + 159, string(values.defend_val_m));
	draw_text(_xx + 40, _yy + 173, string(values.defend_val_sd));

	draw_text(_xx + 30, _yy + 194, string(values.support_val_m));
	draw_text(_xx + 40, _yy + 207, string(values.support_val_sd));

	for (var _i = 0; _i < values.xp_to_level; _i++)
	{
	...
	for (var _i = 0; _i < values.current_xp; _i++)
	{
