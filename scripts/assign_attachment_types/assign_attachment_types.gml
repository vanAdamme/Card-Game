function assign_attachment_types()
{
	...
	//STRONG
	StrongCore			= new AttachmentType("Strong Core",			obj_mech_strong_core,		MECH_PART.CORE,			obj_mech_strong_inv_core,		20,	10, "Description goes here.",	[BasicSupport, 2], [BasicAttack, 1]);
	StrongHead			= new AttachmentType("Strong Head",			obj_mech_strong_head,		MECH_PART.HEAD,			obj_mech_strong_inv_head,		20,	10, "Description goes here.",	[MegaAttack, 1]);
	StrongLeftArm		= new AttachmentType("Strong Left Arm",		obj_mech_strong_left_arm,	MECH_PART.LEFT_ARM,		obj_mech_strong_inv_left_arm,	20,	10, "Description goes here.",	[MegaAttack, 2]);
	StrongRightArm		= new AttachmentType("Strong Right Arm",	obj_mech_strong_right_arm,	MECH_PART.RIGHT_ARM,	obj_mech_strong_inv_right_arm,	20,	10, "Description goes here.",	[MegaAttack, 2]);
	StrongLeftLeg		= new AttachmentType("Strong Left Leg",		obj_mech_strong_left_leg,	MECH_PART.LEFT_LEG,		obj_mech_strong_inv_left_leg,	20,	10, "Description goes here.",	[BasicDefend, 1]);
	StrongRightLeg		= new AttachmentType("Strong Right Leg",	obj_mech_strong_right_leg,	MECH_PART.RIGHT_LEG,	obj_mech_strong_inv_right_leg,	20,	10, "Description goes here.",	[BasicDefend, 1]);
